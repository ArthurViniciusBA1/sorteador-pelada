...
export function HomeScreen() {
  return (
    <div className="mx-auto flex h-dvh w-full max-w-3xl flex-col overflow-hidden">
      <header className="flex shrink-0 flex-col items-center gap-2 bg-primary px-4 py-8 text-primary-foreground">
        <FootballIcon className="size-10" />
        <h1 className="text-center font-heading text-2xl font-bold tracking-tight">SorteiaFut</h1>
